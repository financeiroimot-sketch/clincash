...
function CardsContas({ contasReceber, contasPagar }: CardsContasProps) {
  ...
  return (
    <Row gutter={[16, 16]}>
      <Col span={6}>
        <Card title="Contas a Receber Realizado" style={{ borderLeft: "4px solid #22c55e" }}>
          <h1 style={{ margin: 0 }}>{formatCurrency(contasReceberRealizado ?? 0)}</h1>
        </Card>
      </Col>
      <Col span={6}>
        <Card title="Contas a Receber Planejado" style={{ borderLeft: "4px solid #3b82f6" }}>
          <h1 style={{ margin: 0 }}>{formatCurrency(contasReceberPlanejado ?? 0)}</h1>
        </Card>
      </Col>
      <Col span={6}>
        <Card title="Contas a Pagar Realizado" style={{ borderLeft: "4px solid #ef4444" }}>
          <h1 style={{ margin: 0 }}>{formatCurrency(contasPagarRealizado ?? 0)}</h1>
        </Card>
      </Col>
      <Col span={6}>
        <Card title="Contas a Pagar Planejado" style={{ borderLeft: "4px solid #f59e0b" }}>
